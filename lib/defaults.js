module.exports = {
  ...
  templateVisibility: {
    // example
    // SIDENAV: ({article,articleCategories}) => {
    //   return true // must return true for enable visibility
    // }
  },
  ...
  toolbarSideIconClass: 'hidden-md-and-up', // => media breakpoint for mobile sidebar right navigation on mobile
