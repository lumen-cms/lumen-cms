...
module.exports = function (moduleOptions) {
  ...
  if (options.googleAnalytics) {
    const googleAnalyticsOptions = Object.assign({}, options.googleAnalytics, {
      debug: {
        sendHitTask: isProd,
        enabled: !isProd
      }
    })
    console.log(googleAnalyticsOptions)
    this.requireModule(['@nuxtjs/google-analytics', googleAnalyticsOptions])
  }
