...
module.exports = async function module (moduleOptions) {
  ...
  this.options.build.optimization.splitChunks.cacheGroups.commons = {
    test: /node_modules[\\/](vue|vue-loader|vue-router|vuex|vue-meta|core-js|@babel\/runtime|axios|webpack|setimmediate|timers-browserify|process|regenerator-runtime|cookie|js-cookie|is-buffer|dotprop|vue-i18n|graphql|accept-language-parser|slugify|vue-ls|eventemitter3|apollo-utilities|vue-apollo|nuxt\.js)[\\/]/,
    chunks: 'all',
    priority: 10,
    name: true
  }
