...
module.exports = function (moduleOptions) {
  ...
  this.extendRoutes((routes, resolve) => {
    ...
    // todo create alias for each list of language
    options.cms.languages.forEach(lang => {
      const alias = options.cms.routesAlias.list.find(i => i[lang]) && options.cms.routesAlias.list.find(i => i[lang])[lang]
      alias && routes.push({
        name: alias,
        path: '/' + alias,
