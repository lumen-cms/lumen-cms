...
module.exports = function (moduleOptions) {
  ...
  console.log(this.options.build.babel)
  ...
  this.extendBuild((config, {isDev, isClient}) => {
    ...
    config.module.rules.push({
      test: /\.js$/,
      loader: ['babel-loader', 'vue-loader', 'style-loader', 'css-loader', 'stylus-loader'],
      include: [resolve('vuetify')]
    })
    config.module.rules.push({
      test: /\.styl$/,
