...
// initialize edit components
  ...
  const middlewarePath = resolve(this.options.srcDir, 'middleware')
  if (!existsSync(middlewarePath)) throw new Error(`[nuxt-graphql-cms] Please create middleware folder and place a file called isAuth.js with following content:
  ...
  // add to vendor
  this.addVendor(['slugify', 'vue-i18n'])
