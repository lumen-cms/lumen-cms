...
module.exports = async function module (moduleOptions) {
  ...
  this.addPlugin({
    src: resolve(__dirname, './templates/middleware/getPageTemplates.plugin.js'),
    fileName: join('lumen-cms', 'getPageTemplatesPlugin.js'),
    options
  })
  this.addTemplate({
    src: resolve(__dirname, './templates/middleware/getPageTemplates.middleware.js'),
    fileName: join('lumen-cms', 'getPageTemplates.js'),
    options
  })
  this.options.router.middleware.push('getPageTemplates')
