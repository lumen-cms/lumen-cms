...
import LcImageLightboxItem from './partials/LcImageLightboxItem'
...
export default {
  ...
  render (h) {
    ...
    const figure = (fileRefLen) && getElementFigure(h, hasSingleFileRef ? LcImageCard : LcImageGallery, figureProps)
...
function getLightboxDialog (h, content, fileReferences) {
  ...
  if (hasSingleFileRef) {
    figure = getElementFigure(h, LcImageLightboxItem, {
      fileRef: fileReferences[0],
      isLightbox: true
    })
  } else {
