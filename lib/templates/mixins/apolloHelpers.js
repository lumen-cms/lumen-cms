...
Vue.mixin({
  methods: {
     ...
     * @returns {Promise.<*>}
     */
    async mutateGql (mutationOptions, mutationName, updateOptimistic) {
      return this.$store.dispatch('mutateGql', {$apollo: this.$apollo, mutationOptions, mutationName, updateOptimistic})
    }
  }
})
