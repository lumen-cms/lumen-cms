...
const components = {
  LcContentRenderer: () => import( /* webpackChunkName: 'content-chunk' */ '~cms/components/view/LcContentRenderer.vue'),
  LcTextImage: () => import( /* webpackChunkName: 'content-chunk' */ '~cms/components/view/LcTextImage.js').then(m => m.default || m),
