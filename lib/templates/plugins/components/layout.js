...
const components = {
  ...
  LcAddress: () => import(/* webpackChunkName: 'layout-chunk' */  '~cms/components/layout/LcAddress.vue'),
  LcDialog: () => import(/* webpackChunkName: 'layout-chunk' */  '~cms/components/layout/LcDialog.vue')
}
