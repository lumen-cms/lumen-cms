...
const components = {
  LcFormContainer: () => import('~~/lib/templates/components/edit/LcFormContainer.vue').then(m => m.default || m),
  LcFormDialogContainer: () => import('~~/lib/templates/components/edit/LcFormDialogContainer.vue').then(m => m.default || m),
  ...
  // code mirror
  LcCodeMirror: () => import('~~/lib/templates/components/edit/LcCodeMirror.vue').then(m => m.default || m),
  // media
