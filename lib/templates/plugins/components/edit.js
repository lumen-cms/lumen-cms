...
const components = {
  ...
  // form
  LcHtmlField: () => import(/* webpackChunkName: 'content-edit-chunk' */ '~cms/components/edit/form/LcHtmlField.vue'),
  ...
  // code mirror
  LcCodeMirror: () => import(/* webpackChunkName: 'content-edit-chunk' */ '~cms/components/edit/form/LcCodeMirror.vue'),
  // media
