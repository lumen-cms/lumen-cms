...
export const mutations = {
  ...
  SET_SECONDARY_NAV: (state, val) => {
    state.activeSecondaryNav = val
  }
...
export const actions = {
   ...
   * @param state
   */
  toggleSecondaryNav ({commit, state}) {
    commit('SET_SECONDARY_NAV', !state.activeSecondaryNav)
  },
   ...
   * @param val
   */
  setSecondaryNav ({commit}, val) {
    commit('SET_SECONDARY_NAV', val)
  }
}
