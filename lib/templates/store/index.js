...
import * as content from '<%= options.pluginRoot %>/store/content/index.js'
import * as apollo from '<%= options.pluginRoot %>/store/apollo/index.js'
import * as general from '<%= options.pluginRoot %>/store/general/index.js'
