// import contentElementStyePreSets from '../../src/components/content/stylePreSets' // todo make extendable with a static file
const contentElementStyePreSets = []
...
export default contentElementStyePreSets.concat([
  {
    value: `header-dark`,
    text: 'Header dark',
    styles: {
